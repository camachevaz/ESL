...
# Verb practice <button type="button" value="Practice!" onclick="getPractice()">Practice!</button>
...
<p style="font-weight:bold;text-transformation:uppercase;" id="verb"></p>

## 2. Pronoun

<p style="font-weight:bold;text-transformation:uppercase;" id="pronoun"></p>

## 3. Tense

<p style="font-weight:bold;text-transformation:uppercase;" id="tense"></p>

## Hint <button id="toggle" type="button" value="Practice!" onclick="toggleHint()">Hide hint</button> 
