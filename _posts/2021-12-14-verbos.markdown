...
Click the button to get a set of Pronoun, Verbe, and Tense Try to make a sentence with these cues.{: .notice--info}

If you need help click the *Show hint* button.{: .notice--warning}
...
<table style="width:100%">
    <thead>
        <tr>
            <th style="width=33.3333%">Pronoun</th>
            <th style="width=33.3333%">Verb</th>
            <th style="width=33.3333%">Tense</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td style="width=33.3333%"><p id="pronoun"></p></td>
            <td style="width=33.3333%"><p id="verb"></p></td>
            <td style="width=33.3333%"><p id="tense"></p></td>
        </tr>
    </tbody>
</table>
