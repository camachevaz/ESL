...
<script>
    ...
    function getPractice(){
        ...
        let mainVerb = pronouns[Math.floor(Math.random()*pronouns.length)];
        let verbs2 = verbs[Math.floor(Math.random()*verbs.length)];
        let types = tenses[Math.floor(Math.random()*tenses.length)];
